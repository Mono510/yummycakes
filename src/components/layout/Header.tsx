...
export default function Header() {
  ...
  return (
    <header className="w-full bg-white border-b border-stone-100 sticky top-0 z-50">
      {/* Primera Fila: Logo, Buscador y Cuenta */}
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between gap-8">
        ...
        <div className="flex-grow max-w-2xl relative">
          ...
          />
          <svg className="absolute left-4 top-3 text-stone-400" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
        </div>

        {/* Acceso y Carrito */}
        <div className="flex items-center gap-4">
          <Link href="/cuenta" className="flex items-center gap-2 text-stone-600 hover:text-rose-500 transition-colors">
